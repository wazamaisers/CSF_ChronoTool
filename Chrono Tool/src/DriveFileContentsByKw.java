...
public class DriveFileContentsByKw {
	 ...
	 */
	public static void main(Drive drive, ArrayList<DatabaseSnapshotEntry> entrys) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DriveFileContentsByKw window = new DriveFileContentsByKw(drive, entrys);
	 ...
	 */
	public DriveFileContentsByKw(Drive drive, ArrayList<DatabaseSnapshotEntry> entrys) {
		initialize(drive, entrys);
	}
